...
<div class="result_box">
	...
	<div class="sep"><span class="std_title"><?php echo esc_attr( get_option('ssr_search_box_ssr_item1') ); ?> :</span><input type="text" id="rid" name="rids" class="std_input std_input_item" onfocus="if(this.value=='Please fill out this field.') {{this.value='';jQuery('#rid').removeClass('needsfilled');}jQuery('#rid').removeClass('needsfilled');}" maxlength="500" placeholder="Please fill out this field."></div>
	<div class="sep"><span class="std_title"><?php echo esc_attr( get_option('ssr_search_box_ssr_item2') ); ?> : </span><input type="text" name="rns" id="rn" class="std_input std_input_item" onfocus="if(this.value=='Please fill out this field.') {this.value='';jQuery('#rn').removeClass('needsfilled');}" maxlength="500" placeholder="Please fill out this field."></div>
	<div class="sep"><span class="std_title"><?php echo esc_attr( get_option('ssr_search_box_ssr_item3') ); ?> :</span><input type="text" id="stn" name="stns" class="std_input std_input_item" onfocus="if(this.value=='Please fill out this field.') {this.value='';jQuery('#stn').removeClass('needsfilled');}" maxlength="500" placeholder="Please fill out this field."></div>
	<div class="sep"><span class="std_title"><?php echo esc_attr( get_option('ssr_search_box_ssr_item4') ); ?> :</span><input maxlength="500" type="text" id="stfn" name="stfns" class="std_input std_input_item" onfocus="if(this.value=='Please fill out this field.') {this.value='';jQuery('#stfn').removeClass('needsfilled');}" maxlength="500" placeholder="Please fill out this field."></div>
	<div class="sep"><span class="std_title"><?php echo esc_attr( get_option('ssr_search_box_ssr_item5') ); ?> :</span><input type="text" id="stpy" name="stnsx" class="std_input std_input_item" onfocus="if(this.value=='Please fill out this field.') {this.value='';jQuery('#stpy').removeClass('needsfilled');}" maxlength="500" placeholder="Please fill out this field."></div>
	<div class="sep"><span class="std_title"><?php echo esc_attr( get_option('ssr_search_box_ssr_item6') ); ?> :</span><select id="stcgpa" class="std_input std_input_item" onfocus="jQuery('#stcgpa').removeClass('needsfilled');"><option value="Please fill out this field." selected>Please fill out this field.</option>
				<?php $args = array(
	...
	<div class="sep"><span class="std_title"><?php echo esc_attr( get_option('ssr_search_box_ssr_item7') ); ?> :</span><select id="stsub" class="std_input std_input_item" onfocus="jQuery('#stsub').removeClass('needsfilled');"><option value="Please fill out this field." selected>Please fill out this field.</option>
	<?php
				$args = array(
