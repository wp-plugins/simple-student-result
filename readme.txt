...
It is hard to continue development and support for this free plugin without contributions from users like you. If you enjoy using Simple Student Result and find it useful, please consider [__making a donation__](http://bit.ly/donatebypaypal/). Your donation will help encourage and support the plugin's continued development and better user support.
...
<ol class="screenshots">
	...
	<li>
		...
		</a>		<p>View result by <b>shortcode [sms_result]</b> (in post editor) or 
...
ans: Yes , you can, you will find CGPA item wp-admin panel below page.
 ...
 == Changelog ==
 1.5.3 Responsive issues fixed.
 1.5.3 Settings Page bug fixed.
 1.5.2 site url updated.
 ...
 1.4.6 few Bug Fixed.
 1.4.5 Major Bug Fixed.
 1.4.4 Some Database Bug Fixed.
